      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-white font-bold font-2xl  mb-1">Features</h6>
                <ul>
                  <li className="mb-1">
                    <Link href="/chat-with-us" className="text-dark-hard hover:text-gray-100 transition duration-150 ease-in-out">Chat</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/chat-with-us" className="text-dark-hard hover:text-gray-100 transition duration-150 ease-in-out">Community chat</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/chat-with-us" className="text-black hover:text-gray-100 transition duration-150 ease-in-out">AI chat bot</Link>
                  </li>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-dark-spansoft text-sm mr-4">&copy; SheRise. All rights reserved.</div>
